              ...
              <div class="form_section">
                <form class="form_contant" action="#" method="post">
                  ...
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Current Mobile Number : <?php echo $phone;?>" type="text" required name="phone" maxlength="10">
                  </div>
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Password" type="Password" required name="upass">
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="main_heading text_align_center">
                <h4><?php 
...
<script src="users/revolution/js/extensions/revolution.extension.video.min.js"></script>
 ...
 <?php
	if(isset($_POST["done"]))
	{
		...
		if($result->num_rows > 0)
		{
			$query ="update user set phone = '$phone' where email = '$uname'";		
			$con->query($query);
			echo $query;
			$con->close();
			$_SESSION["msg"] = "Mobile Number Updated";
		...
		else
		{
			...
			header("location:update_phone-no_user.php");
		}
	}
?>