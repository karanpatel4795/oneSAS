      ...
      <div class="col-sm-12 col-md-12">
        <div class="product-table">
          <table class="table">
            ...
            <tbody>
           <?php
	$query = "select providers.category, booking.providername, booking.time, booking.canbyuserreasone from providers, booking where providers.email = booking.providername and canbyuser = 1 ";
