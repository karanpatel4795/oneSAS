          ...
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">View Cancle Booking</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-12 col-md-12">
        <div class="product-table">
          <table class="table">
            ...
            <tbody>
           <?php
	$query = "select providers.category, booking.providername, booking.time, booking.canbyproviderreasone from providers, booking where providers.email = booking.providername and canbyprovider = 1 ";
	...
	$result = $con->query($query);
		...
		while($row = $result->fetch_assoc())
		{
			...
			echo  "<tr>
                  ...
                  <td>$row[time]</td>
				  <td>$row[canbyproviderreasone]</td>
                </tr>";
				$cnt++;
		}
?>
