          ...
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">View Pending Booking</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-12 col-md-12">
        <div class="product-table">
          <table class="table">
            ...
            <tbody>
           <?php
	$query = "select providers.category,booking.sr, booking.uname, booking.providername, booking.time from providers, booking where providers.email = booking.providername and canbyprovider = 0 and canbyuser = 0 and completeorder = 0 and booking.uname = '$uname'";
	//echo $query;
