          ...
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">View All Completed Booking</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-12 col-md-12">
        <div class="product-table">
          <table class="table">
            ...
            <tbody>
           <?php
	$query = "select providers.category, booking.providername, booking.time, booking.comp_time  from providers, booking where providers.email = booking.providername and completeorder = 1 ";
