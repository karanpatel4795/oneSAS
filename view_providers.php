...
<div class="section padding_layout_1 Shopping_cart_section">
  <div class="container">
	...
	$query = "select * from providers where category = '$cname' and status = 1";	
...
?>		
          ...
          <table class="table">
            <tbody><tr class="cart-form"><td class="actions">
            <div class="coupon"><form action="#" method="post">
            <select name="city" class="input-text" required>
			<?php
				
				$query = "select * from providers where category = '$cname'";
				$result = $con->query($query);
				echo "<option disabled> -Select City for Service $cname -</option>";
				...
				?></select>
					<a href='view_providers_city.php'><input class='button' type='submit' value="Search City" name="done"></a>
					</div>
                    </form>
...
<?php
	if(isset($_POST["done"]))
	{
		...
		header("location:view_providers_city.php?cname=$cname&city=$city");
	}
?>