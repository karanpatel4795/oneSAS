              ...
              <div class="form_section">
                <form class="form_contant" action="#" method="post">
                  ...
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Current City : <?php echo $city;?>" type="text" required name="city">
                  </div>
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
<script src="users/revolution/js/extensions/revolution.extension.video.min.js"></script>
 ...
 <?php
	if(isset($_POST["done"]))
	{
		...
		if($result->num_rows > 0)
		{
			$query ="update user set city = '$city' where email = '$uname'";		
			$con->query($query);
			echo $query;
			$con->close();
		...
		else
		{
			...
			header("location:update_city_user.php");
		}
	}
?>