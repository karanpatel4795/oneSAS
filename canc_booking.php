              ...
              <div class="form_section">
                <form class="form_contant" action="#" method="post">
                  ...
                  <div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <textarea class="field_custom" placeholder="Enter Reason" required name="reason" cols="50" style="resize:none;"></textarea>
                  </div>
                					    
                  <div class="center">
                    <button class="btn main_bt" value="Cancel Booking" name="done">Cancel Booking</button>
                  </div>
                  </fieldset>
                </form>
              </div>
...
<?php
	...
	{
		$reason = $_POST["reason"];
		$query = "update booking set canbyuserreasone = '$reason',
		canbyuser = 1 where sr = $sr";
		$con->query($query);
		$con->close();
		header("location:view_canby_you.php");
	}
?>
