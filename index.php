...
<div class="section padding_layout_1">
  <div class="container">
    <?php //require_once("why-choose-us.php"); ?>  
  </div>
</div>
<!-- end section -->
<!-- section -->
<div class="section padding_layout_1 light_silver gross_layout">
  <div class="container">
    <?php require_once("service-process.php"); ?> 
...
<div class="section padding_layout_1">
  <div class="container">
   <div class="row">
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            <h2>Category</h2>
            <p class="large">We provides service providers with best services to make you a happy customer.</p>
          </div>
        </div>
      </div>
    </div>
	...
	$query = "select * from category where status = 1 LIMIT 8";	
	...
	if($result->num_rows > 0)
	{
		...
		{
			echo "<div class='col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all'>
        <div class='product_list'>
          <div class='product_img'> <img class='img-responsive' src='admin/$row[cimage]' alt='' height='300px' width='90%' > </div>
...
?>
    ...
    <div class="price_bottom">
                  <div class="center"><a href='view_all_category.php'><button type='button' class='bt_main' title='View More Category'>View More Categories</button></a></div>
                </div>
   </div>
</div>
<!-- end section -->
...
<!-- section -->
<?php require_once("what_clients_says.php"); ?>
<!-- end section -->
