<?php 
	...
	$query = "select * from providers where email = '$provider' and category = '$cname'";
            ...
            <div class="row">
              <div class="price_table_inner margin_bottom_30">
                <div class="price_head text_align_center white_fonts">
                  <img src='Provider/<?php echo $photo; ?>' height="100" width="100" border="2" style="border-radius:15px;">
                </div>
                <div class="price_contant">
                  <div class="price_cont">
                    ...
                    <p>Minimum Charges (INR): <?php echo $charges; ?></p>
                    <p>Experience: <?php echo $exp; ?></p>
                    <p>Rate: <?php echo $rate; ?></p>
                  </div>
                </div>
                <div class="price_bottom">
                  <div class="center"> <?php echo "<a href='bookings.php?provider=$email & cname=$cname'><button type='button' class='bt_main' title='Book Now'>Book</button></a>"; ?> </div>
                </div>
              </div>
            </div>
          </div>
