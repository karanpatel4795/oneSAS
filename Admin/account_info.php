              		...
              		<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                              ...
                              <div class="form-body">
                                  <form> 
                                    ...
                                    <a href="Change_password_admin.php"><button type="button" class="btn btn-default"> Change Password </button></a>
                                    &nbsp;&nbsp;
                                    <a href="change_sec_que_admin.php"><button type="button" class="btn btn-default"> Change Security Questions </button></a>
                                 </form> 
                                 <div>
								<?php 
