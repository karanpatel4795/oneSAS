...
<!--=============================================================== Code Here =========================================================================-->              <div class="tables">
	...
	while($row = $result->fetch_assoc())
	{
		echo "<tr>
                  ...
                  <td>$row[uname]</td>
                  <td>$row[time]</td>
                  <td><a href='view_booking.php?sr=$row[sr] & username=$row[uname]'>View Details</a></td>
				   <td><a href='comp_booking.php?sr=$row[sr]'>Complete</a></td>
                  <td><a href='canc_booking.php?sr=$row[sr]'>Cancel Booking</a></td>
                </tr>";
				$cnt++;
	}
 ?>
