...
<!--=============================================================== Code Here =========================================================================-->               <form class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
                            ...
                            <div class="form-group"> 
                            	...
                            	<input type="number" name="phone" class="form-control" id="exampleInputEmail1" placeholder="Current Phone Number: <?php echo $phone; ?>" required> 
                            </div> 
                              <div>
							<?php 
 ...
 <?php
	if(isset($_POST["done"]))
	{
		...
		if($result->num_rows > 0)
		{
			$query ="update providers set phone = '$phone' where email = '$uname'";		
			$con->query($query);
			echo $query;
			$con->close();
		...
		else
		{
			...
			header("location:change_phone_no_provider.php");
		}
	}
?>