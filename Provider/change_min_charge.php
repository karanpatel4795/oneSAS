...
<!--=============================================================== Code Here =========================================================================-->               <form class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
                            ...
                            <div class="form-group"> 
                            	...
                            	<input type="number" name="charge" class="form-control" id="exampleInputEmail1" placeholder="Current Minimum Charge: <?php echo $charge; ?>" required> 
                            </div> 
                              <div>
							<?php 
 ...
 <?php
	if(isset($_POST["done"]))
	{
		...
		if($result->num_rows > 0)
		{
			$query ="update providers set charges = '$charge' where email = '$uname'";		
			$con->query($query);
			echo $query;
			$con->close();
			$_SESSION["msg"] = "Minimum Charge Updated";
		...
		else
		{
			...
			header("location:change_min_charge.php");
		}
	}
?>