          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                ...
                <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" placeholder="Enter Reason" required name="reason">
				<hr>
         <input type="submit" class="btn btn-primary btn-block" value="Cancel Booking" name="done">
         <br>
              </div>
            </div>
          </div>
...
<?php
	...
	{
		$reason = $_POST["reason"];
		$query = "update booking set canbyproviderreasone = '$reason',
		canbyprovider = 1, notify = 1 where sr = $sr";
		$con->query($query);
		$con->close();
