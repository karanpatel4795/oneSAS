              	...
              	<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                    ...
                    <div class="form-body">
                     ...
                     <form action="#" method="post">
                        ...
                        <tr>
                            <td>Photo</td>
                            <td> <img src='../<?php echo $photo; ?>' height="150" width="150" border="2"></td>
                        </tr>
                        <tr>
                        <td>Name</td>
                        ...
                        <tr>
                            <td>Actions</td>
                            <td><a href="comp_booking.php?sr=$row[sr]">Complete Order</a> | <a href="canc_booking.php?sr=$row[sr]">Cancel Booking</a> </td> 
                        </tr>
